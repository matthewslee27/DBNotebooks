...
# MAGIC | 10M  | **[Reading Data - Parquet]($./Reading & Writing Data/Reading Data 2 - Parquet)** | *The #1 recomended format for storing big-data* |
...
# MAGIC | 10m  | **Break** || 
# MAGIC | 50m  | **[Intro To DataFrames Part-2]($./Intro To DataFrames/Intro To DF Part 2)**      | *orderBy(), Column, filter(), first(), Row, collect(), take(n), Dataframe vs. DataSet* |
# MAGIC | 10m  | **Break** || 

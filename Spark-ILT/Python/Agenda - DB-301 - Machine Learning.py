...
# MAGIC | | ILT | **[MLE 03a - Data Cleansing w/Apache Spark]($./Machine Learning/ML Electives/MLE 03a - Data Cleansing with Apache Spark)** | *Data cleansing techniques for Data Scientest* |
# MAGIC | | SGL | **[MLE 03b - Data Cleansing Lab w/Airbnb]($./Machine Learning/ML Electives/MLE 03b - Data Cleansing Lab with Airbnb)** | *Hands on practice cleaning the Airbnb SF dataset* |
# MAGIC | | SGL | **[MLE 03c - Linear Regression Lab w/Airbnb]($./Machine Learning/ML Electives/MLE 03c - Linear Regression Lab with Airbnb)** | *Real-world predictions with Airbnb & LinearRegression* |
# MAGIC | | ILT | **[MLE 03d - Gradient Boosting w/Airbnb]($./Machine Learning/ML Electives/MLE 03d - Gradient Boosting with Airbnb)** | *More Predictions using XGBoost & Light GBM* |
